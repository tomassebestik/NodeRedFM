...
const location = "Morn aklimatizace";
const limitsGlobalSetTo = "limityTopeniMornAklimatizace";
const optimalWorkingTemperature = 14; // graph center axis
