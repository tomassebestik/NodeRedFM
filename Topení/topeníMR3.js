...
const quidoDrivenOutput = 3;
const quidoOutputTime = 255;
const heatingLimitsHall = "limityTopeniMorn";

const sensorPrimaryStatus = global.get("senzoryMorn.stavS2");
const sensorPrimaryTemperature = global.get("senzoryMorn.teplota2");
const sensorBackupTemperature = global.get("senzoryMorn.teplota3");

var manualControl = global.get("heatManualMorn");
var UIswitch = global.get("mornControl_topeniMR3");
