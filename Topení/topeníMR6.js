...
const sensorPrimaryStatus = global.get("senzoryMorn.stavS5");
const sensorPrimaryTemperature = global.get("senzoryMorn.teplota5");
const sensorBackupTemperature = global.get("senzoryMorn.teplota6");

var manualControl = global.get("heatManualMorn");
var UIswitch = global.get("mornControl_topeniMR6");
