...
const quidoDrivenOutput = 10;
const heatingLimitsHall = 'limityTopeniSvarovna';
const energyTrigger = 3; //EMAX disconnect LEVEL
const antiFreeze = global.get('antiFreezeSVA3');

var manualControl = global.get('heatManualSvarovna');
var UIswitch = global.get('svarControl_privod3');
