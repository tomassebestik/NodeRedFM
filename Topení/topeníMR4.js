...
const heatingLimitsHall = "limityTopeniMornAklimatizace";

const sensorPrimaryStatus = global.get("senzoryMorn.stavS1");
const sensorPrimaryTemperature = global.get("senzoryMorn.teplota1");
const sensorBackupTemperature = global.get("senzoryMorn.teplota3");

var manualControl = global.get("heatManualMorn");
var UIswitch = global.get("mornControl_topeniMR4");
