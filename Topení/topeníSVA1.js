...
const quidoDrivenOutput = 14;
const quidoOutputTime = 255;

var sensorPrimaryStatus = global.get('senzorySvarovna.stavS1');
var sensorPrimaryTemperature = global.get('senzorySvarovna.teplota1');
var sensorBackupTemperature = global.get('senzorySvarovna.teplota4');
var manualControl = global.get('heatManualSvarovna');

var UIswitch = global.get('svarControl_topeni1');
var mainBranchSwitch = global.get('svarControl_privod1');
...
global.set('antiFreezeSVA1', antiFreeze);
return [ msg1, msg2 ];
